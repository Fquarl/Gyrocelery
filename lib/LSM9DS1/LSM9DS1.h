...
class LSM9DS1{
  public:
    ...
    */
    ...
    /**
     *  \fn         readFifo
     *  \brief      Reads all the data stored in the FIFO to the provided storedGyroData struct
     */
    void readFifo(storedGyroData* data);

  private:
    storedGyroData* data = new storedGyroData();
    int accelGyroAddr;
    int magnetoAddr;
    int accelPrescale = 2;
